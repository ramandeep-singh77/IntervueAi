...
@app.get("/api/health")
def health_check():
    return {"status": "healthy", "environment": "render"}
...
def export_results(session_id: str, format: str = "json"):
    try:
        ...
        export_data = {
            ...
            "summary": "InterVue AI - Interview Practice Results"
        }
...
def get_available_roles():
    return {"roles": ["Software Engineer", "HR", "Data Analyst", "Product Manager", "Marketing", "Sales"]}
