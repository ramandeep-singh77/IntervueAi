...
DEMO_QUESTIONS = {
    ...
    "HR": {
        "Fresher": [
            ...
            {
                "id": 3,
                "question": "What do you think are the most important qualities for an HR professional?",
                "type": "behavioral",
                "difficulty": "easy",
                "expected_duration": 60
            },
            {
                "id": 4,
                "question": "Describe a time when you had to communicate difficult information to someone.",
                "type": "behavioral",
                "difficulty": "medium",
                "expected_duration": 90
            },
            {
                "id": 5,
                "question": "How would you approach recruiting candidates for a technical role?",
                "type": "situational",
                "difficulty": "medium",
                "expected_duration": 90
            }
        ...
        "Experienced": [
            ...
            {
                "id": 3,
                "question": "How do you handle sensitive employee relations issues?",
                "type": "situational",
                "difficulty": "hard",
                "expected_duration": 120
            },
            {
                "id": 4,
                "question": "What strategies do you use for talent retention and employee engagement?",
                "type": "technical",
                "difficulty": "hard",
                "expected_duration": 120
            },
            {
                "id": 5,
                "question": "Tell me about a time you had to manage organizational change.",
                "type": "behavioral",
                "difficulty": "hard",
                "expected_duration": 120
            }
    ...
    "Data Analyst": {
        "Fresher": [
            ...
            {
                "id": 4,
                "question": "Describe a data project you worked on and the insights you discovered.",
                "type": "behavioral",
                "difficulty": "medium",
                "expected_duration": 90
            },
        ...
        "Experienced": [
            ...
            {
                "id": 2,
                "question": "Describe your experience with data visualization and storytelling with data.",
                "type": "technical",
                "difficulty": "medium",
                "expected_duration": 90
            },
            {
                "id": 3,
                "question": "How do you handle missing or inconsistent data in large datasets?",
                "type": "technical",
                "difficulty": "hard",
                "expected_duration": 120
            },
            ...
            {
                "id": 5,
                "question": "What's your process for identifying trends and patterns in complex data?",
                "type": "technical",
                "difficulty": "hard",
                "expected_duration": 120
            }
...
async def analyze_audio(
    ...
    try:
        if not audio_analyzer:
            ...
            return {
                "transcript": {
                    "transcript": "Audio analysis not available in serverless mode",
                    "word_count": 0,
                    "speaking_rate": 0,
                    "filler_words": [],
                    "filler_word_count": 0,
        ...
        temp_audio_path = f"/tmp/temp_audio_{session_id}_{question_index}.wav"
...
async def analyze_video(
    ...
    try:
        ...
        temp_video_path = f"/tmp/temp_video_{session_id}_{question_index}.webm"
...
# Include all other endpoints from main.py with similar error handling...
# (I'll add the remaining endpoints in the next part)
    ...
    for response in responses:
        ...
        if transcript:
            ...
            if word_count > 0:
                ...
                speech_score = max(0, 100 - (filler_percentage * 5))
            else:
                speech_score = 0
